...
export const metadata: Metadata = {
  title: 'Terms of Service | Out Sea Hub',
  description: 'Terms of Service for Out Sea Hub AI image generation platform. Read our terms and conditions for using our professional AI image generation service.',
  ...
  openGraph: {
    title: 'Terms of Service | Out Sea Hub',
    description: 'Terms of Service for Out Sea Hub AI image generation platform.',
    url: '/terms',
  },
  twitter: {
    card: 'summary',
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                This website is operated by Out Sea Hub. Throughout the site, the terms "we", "us", and "our" refer to Out Sea Hub. 
                Out Sea Hub provides this website, including all information, tools, and services available from this site to you, 
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                All content and materials on this website are the property of Out Sea Hub and are protected by copyright, trademark, and other relevant laws. You may view, copy, and print materials from the website strictly in accordance with these Terms of Service.
              </p>
              <p className="mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                This website, along with all the information, content, and materials, is provided by Out Sea Hub on an "as is" and "as available" basis. Out Sea Hub makes no representations or warranties of any kind, whether express or implied.
              </p>
              <p className="mb-4">
                Out Sea Hub will not be liable for any damages of any kind arising from your use of this website or our AI image generation service.
              </p>
            </section>
