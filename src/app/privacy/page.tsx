...
export const metadata: Metadata = {
  title: 'Privacy Policy | Out Sea Hub',
  description: 'Privacy Policy for Out Sea Hub AI image generation platform. Learn how we protect your data when using our professional AI image generation service.',
  ...
  openGraph: {
    title: 'Privacy Policy | Out Sea Hub',
    description: 'Privacy Policy for Out Sea Hub AI image generation platform.',
    url: '/privacy',
  },
  twitter: {
    card: 'summary',
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-8">
              At Out Sea Hub, we are committed to protecting the privacy and security of our users. Understanding the importance of privacy, we strive to ensure that our data collection, usage, and sharing practices respect your privacy rights when using our AI image generation platform.
            </p>
            ...
            <section className="mb-8">
              <p className="mb-4">
                By using our AI image generation website, you acknowledge that you have read and understand this Privacy Policy. For any questions or concerns regarding this policy or your personal data, please contact us directly at luotao962@gmail.com.
              </p>
            </section>
          </div>
        </div>
