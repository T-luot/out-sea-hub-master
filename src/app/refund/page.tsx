...
export const metadata: Metadata = {
  title: 'Refund Policy | Out Sea Hub',
  description: 'Refund Policy for Out Sea Hub AI image generation platform. Learn about our refund terms for subscription plans and credit purchases.',
  ...
  openGraph: {
    title: 'Refund Policy | Out Sea Hub',
    description: 'Refund Policy for Out Sea Hub AI image generation platform.',
    url: '/refund',
  },
  twitter: {
    card: 'summary',
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-8">
              At Out Sea Hub, we aim to ensure complete satisfaction with our AI image generation services. This policy outlines our terms and conditions for subscription plan changes and refunds.
            </p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                If you have any questions about our refund policy or need to request a refund for our AI image generation services, please contact our support team at luotao962@gmail.com.
              </p>
              <p className="mb-4">
