...
export const metadata: Metadata = generateMultilingualMetadata({
  title: 'Pricing Plans - Out Sea Hub AI Image Generation | Affordable AI Art',
  description: 'Choose the perfect plan for your AI image generation needs. Out Sea Hub offers flexible pricing for professional AI image creation, editing, and processing.',
  keywords: [
