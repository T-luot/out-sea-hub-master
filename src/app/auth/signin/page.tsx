...
export const metadata: Metadata = {
  title: 'Sign In - Access Your AI Image Generation Account | Out Sea Hub',
  description: 'Sign in to your Out Sea Hub account to access AI-powered image generation tools. Create professional images with advanced AI technology instantly.',
  keywords: [
    'sign in',
    'login',
