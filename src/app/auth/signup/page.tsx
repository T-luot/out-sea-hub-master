...
export const metadata: Metadata = {
  title: 'Sign Up - Create Your AI Image Generation Account | Out Sea Hub',
  description: 'Create your free Out Sea Hub account to access professional AI image generation tools. Start creating stunning images with advanced AI technology today.',
  keywords: [
    'sign up',
    'create account',
