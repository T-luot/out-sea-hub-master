...
const koDictionary = {
  ...
  features: {
    title: "Out Sea Hub AI 플랫폼의 주요 기능",
    subtitle: "우리의 Out Sea Hub AI는 최첨단 기술을 결합하여 하나의 완벽한 플랫폼에서 전문적인 이미지 생성과 편집을 제공합니다.",
    items: [
      {
        title: "텍스트-이미지 생성",
  ...
  faq: {
    title: "자주 묻는 질문",
    subtitle: "Out Sea Hub AI 플랫폼과 강력한 이미지 생성 기능에 대한 일반적인 질문의 답변을 찾아보세요.",
    items: [
      {
        question: "Out Sea Hub AI란 무엇인가요?",
        answer: "Out Sea Hub AI는 최첨단 인공지능을 사용하여 텍스트 설명에서 놀라운 이미지를 만들고, 기존 이미지를 편집하며, 여러 이미지를 동시에 처리하는 고급 이미지 생성 플랫폼입니다."
      }
    ]
  },
  cta: {
    title: "놀라운 이미지를 만들 준비가 되셨나요?",
    subtitle: "Out Sea Hub AI를 사용하여 아이디어를 실현하는 수천 명의 크리에이터들과 함께하세요.",
    button: "지금 시작하기"
  },
  footer: {
    brand: {
      ...
      copyright: "© 2025 Out Sea Hub. 모든 권리 보유."
    },
    contact: {
      title: "연락처",
