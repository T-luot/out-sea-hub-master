...
export const EN_DICTIONARY: HomeDictionary = {
  ...
  features: {
    title: "Key Features of Out Sea Hub AI Platform",
    subtitle: "Our Out Sea Hub AI combines cutting-edge technology to deliver professional image generation and editing in one seamless platform.",
    items: [
      {
  ...
  faq: {
    ...
    subtitle: "Find answers to common questions about our Out Sea Hub AI platform and its powerful image generation features.",
    items: [
      {
  ...
  cta: {
    ...
    subtitle: "Join thousands of creators using Out Sea Hub AI to bring their ideas to life.",
  ...
  footer: {
    brand: {
      ...
      copyright: "© 2025 Out Sea Hub. All rights reserved."
    },
    contact: {
      title: "Contact",
