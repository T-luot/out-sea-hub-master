          ...
          <div id="overview" className="space-y-8 mb-16">
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <p className="text-muted-foreground">
                The Out Sea Hub API provides a simple REST interface to our AI image generation models. 
                ...
                <div className="bg-white/70 dark:bg-gray-800/70 border border-blue-200 dark:border-blue-600 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between text-gray-700 dark:text-gray-300">
                      <span>Out Sea Hub Pro</span>
                      <span className="font-mono font-medium">$0.05</span>
                    </div>
                    <div className="flex justify-between text-gray-700 dark:text-gray-300">
                      <span>Out Sea Hub Max</span>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-t border-border">
                      <td className="p-4 font-medium">Out Sea Hub Pro</td>
                    ...
                    <tr className="border-t border-border">
                      <td className="p-4 font-medium">Out Sea Hub Max</td>
            ...
            <div className="bg-card border rounded-lg p-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ol className="space-y-2 text-sm text-muted-foreground">
                    <li>1. Sign up for a Out Sea Hub account</li>
