...
export function OrganizationSchema() {
  const organizationData = {
    ...
    "@type": "Organization",
    "name": "Out Sea Hub",
    "url": process.env.NEXT_PUBLIC_SITE_URL || "https://outseahub.com",
    "logo": {
      "@type": "ImageObject",
      "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://outseahub.com"}/logo.png`,
      "width": 256,
      "height": 256
    },
    ...
    "sameAs": [
      ...
      "https://github.com/fluxkontext/outseahub.com"
    ],
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "US"
...
export function WebSiteSchema() {
  const websiteData = {
    ...
    "potentialAction": {
      ...
      "target": {
        "@type": "EntryPoint",
        "urlTemplate": `${process.env.NEXT_PUBLIC_SITE_URL || "https://outseahub.com"}/search?q={search_term_string}`
      },
...
export function SoftwareApplicationSchema() {
  const softwareData = {
    ...
    "offers": {
      ...
      "price": "0",
      "priceCurrency": "USD",
      "description": "Free AI image generation with Out Sea Hub",
    ...
    "screenshot": `${process.env.NEXT_PUBLIC_SITE_URL || "https://outseahub.com"}/screenshot.png`,
    "aggregateRating": {
...
export function ProductSchema() {
  const productData = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Out Sea Hub AI Image Generation Service",
    "description": "Professional AI image generation service with multiple pricing plans powered by Out Sea Hub technology",
    "brand": {
      "@type": "Brand",
      "name": "Out Sea Hub"
    },
    ...
    "offers": [
      ...
      },
      {
        ...
        "priceValidUntil": "2025-12-31",
        "availability": "https://schema.org/InStock",
        "description": "Enhanced AI image generation with Out Sea Hub Pro"
      },
      {
        "@type": "Offer",
        "name": "Max Plan",
        ...
        "priceValidUntil": "2025-12-31",
        "availability": "https://schema.org/InStock",
        "description": "Premium AI image generation with Out Sea Hub Max"
      },
      {
        "@type": "Offer",
...
export function VideoObjectSchema({ 
  ...
  const videoData = {
    ...
    "duration": duration,
    "contentUrl": `${process.env.NEXT_PUBLIC_SITE_URL || "https://outseahub.com"}/videos/sample.mp4`,
    "embedUrl": `${process.env.NEXT_PUBLIC_SITE_URL || "https://outseahub.com"}/embed/sample`,
    "publisher": {
      "@type": "Organization",
      "name": "Out Sea Hub",
      "logo": {
...
export function StructuredData() {
  const organizationSchema = {
    ...
    "logo": "https://outseahub.com/logo.png",
    "description": "Professional AI image generation platform powered by Out Sea Hub. Create stunning images from text descriptions with advanced AI technology.",
    "sameAs": [
      "https://twitter.com/fluxkontext",
  ...
  const websiteSchema = {
    ...
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://outseahub.com/search?q={search_term_string}",
      "query-input": "required name=search_term_string"
    }
  }
