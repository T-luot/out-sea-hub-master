...
const faqItems: FAQItem[] = [
  {
    question: "What is Out Sea Hub AI?",
    answer: "Out Sea Hub AI is an advanced image generation platform that uses cutting-edge artificial intelligence to create stunning images from text descriptions, edit existing images, and process multiple images simultaneously."
  },
  {
  ...
  {
    question: "Can I edit existing images with Out Sea Hub?",
  ...
  },
  {
    ...
    answer: "Out Sea Hub AI supports multiple aspect ratios including 1:1, 16:9, 9:16, 4:3, 3:2, and 21:9. You can export images in JPEG and PNG formats at high resolution for professional use."
  },
  {
  ...
  {
    question: "What makes Out Sea Hub different from other AI image generators?",
    answer: "Out Sea Hub stands out with its advanced Flux Pro and Max models, professional image editing capabilities, multi-image processing, and flexible aspect ratio support all in one seamless platform."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, images generated through Out Sea Hub AI can typically be used for commercial purposes. Please review the specific terms of service and licensing agreements for detailed usage rights."
  }
]
