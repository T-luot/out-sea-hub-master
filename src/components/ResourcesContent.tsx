...
const resourceCategories = [
  {
    ...
    description: "Learn how to master Out Sea Hub AI image generation",
    icon: BookOpen,
    resources: [
      {
        title: "Getting Started with Out Sea Hub",
  ...
  },
  {
    ...
    resources: [
      {
        title: "Out Sea Hub API Documentation",
      ...
      {
        title: "Python SDK",
        description: "Official Python library for Out Sea Hub",
        type: "SDK",
        link: "#",
        difficulty: "Developer"
      },
      {
        ...
        description: "Use Out Sea Hub with ComfyUI workflows",
        type: "Integration",
        link: "#",
        difficulty: "Intermediate"
      }
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6 gradient-text">
            Out Sea Hub Resources Hub
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Everything you need to master AI image generation with Out Sea Hub. 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Create your free Out Sea Hub account
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-primary/10 to-purple-500/10">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join thousands of creators using Out Sea Hub to bring their imagination to life.
          </p>
