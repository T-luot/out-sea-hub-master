      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground2 text-sm leading-relaxed">
              {footer.brand.description}
            </p>
            <div className="text-sm text-muted-foreground2">
          ...
          {/* Contact & Legal - 中间栏目 */}
          <div className="space-y-4">
            <h3 className="font-semibold text-foreground2">{footer.contact.title}</h3>
            <a
              href={`mailto:${footer.contact.email}`}
              className="block text-muted-foreground2 hover:text-primary2 hover:font-semibold active:scale-95 transition-all duration-200 text-sm"
            >
              {footer.contact.email}
            </a>

            <div className="pt-4">
              <h3 className="font-semibold text-foreground2 mb-3">{footer.legal.title}</h3>
          ...
          {/* Languages - 右边栏目 */}
          <div className="space-y-4">
            <h3 className="font-semibold text-foreground2">{footer.languages.title}</h3>
                ...
                <a
                  ...
                  className={`flex items-center space-x-2 transition-all duration-200 text-sm py-1 hover:font-semibold active:scale-95 ${
                    lang.code === 'en' 
                      ...
                      : 'text-muted-foreground2 hover:text-primary2'
                  }`}
                >
                  <span>{lang.flag}</span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <a 
                ...
                className="text-muted-foreground2 hover:text-primary2 hover:scale-110 active:scale-95 transition-all duration-200" 
