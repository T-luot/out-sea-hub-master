...
1. **Canonical链接配置不一致**
   ...
   // ❌ 问题1: layout.tsx中的配置
   alternates: {
     canonical: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://outseahub.com').origin,
     languages: {
...
```
默认语言 (英语):
https://outseahub.com/           → 首页
https://outseahub.com/generate   → 生成页面
https://outseahub.com/pricing    → 定价页面

其他语言:
https://outseahub.com/zh/        → 中文首页
https://outseahub.com/zh/generate → 中文生成页面
https://outseahub.com/de/pricing  → 德语定价页面
```

#### **Canonical + hreflang策略**
```html
<!-- 英语页面 (默认) -->
<link rel="canonical" href="https://outseahub.com/generate" />
<link rel="alternate" hreflang="en" href="https://outseahub.com/generate" />
<link rel="alternate" hreflang="zh" href="https://outseahub.com/zh/generate" />
<link rel="alternate" hreflang="de" href="https://outseahub.com/de/generate" />
<link rel="alternate" hreflang="x-default" href="https://outseahub.com/generate" />

<!-- 中文页面 -->
<link rel="canonical" href="https://outseahub.com/zh/generate" />
<link rel="alternate" hreflang="en" href="https://outseahub.com/generate" />
<link rel="alternate" hreflang="zh" href="https://outseahub.com/zh/generate" />
<link rel="alternate" hreflang="x-default" href="https://outseahub.com/generate" />
```
...
export function generateMultilingualMetadata(config: MetadataConfig): Metadata {
  ...
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://outseahub.com'
...
<!-- 每个页面包含所有语言版本 -->
<url>
  <loc>https://outseahub.com/generate</loc>
  <xhtml:link rel="alternate" hreflang="en" href="https://outseahub.com/generate"/>
  <xhtml:link rel="alternate" hreflang="zh" href="https://outseahub.com/zh/generate"/>
  <xhtml:link rel="alternate" hreflang="x-default" href="https://outseahub.com/generate"/>
</url>
```
