...
https://outseahub.com/generate            # 生成器
https://outseahub.com/pricing             # 定价
https://outseahub.com/resources           # 资源
https://outseahub.com/features            # 功能
```

#### **其他语言版本 - 75个页面**
```
https://outseahub.com/zh/                 # 中文首页
https://outseahub.com/zh/generate         # 中文生成器
https://outseahub.com/zh/pricing          # 中文定价
https://outseahub.com/zh/resources        # 中文资源
https://outseahub.com/zh/features         # 中文功能
https://outseahub.com/de/                 # 德语首页
https://outseahub.com/de/generate         # 德语生成器
... (其他13种语言 × 5个页面)
```
...
```
# 法律页面 (3个)
https://outseahub.com/terms               # 条款
https://outseahub.com/privacy             # 隐私
https://outseahub.com/refund              # 退款

# NOINDEX页面 (4个)
https://outseahub.com/dashboard           # 仪表板
https://outseahub.com/auth/signin         # 登录
https://outseahub.com/auth/signup         # 注册
https://outseahub.com/admin               # 管理
```
