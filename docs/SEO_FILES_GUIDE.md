...
# 网站地图位置
Sitemap: https://outseahub.com/sitemap.xml
```
...
curl https://outseahub.com/llms.txt

# 检查AI爬虫是否能正确访问
curl -H "User-Agent: GPTBot" https://outseahub.com/llms.txt
```
